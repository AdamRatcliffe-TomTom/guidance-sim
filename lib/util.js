...
function speed(speed, frequency) {
  var constant = Number(speed.slice(0, speed.indexOf("x")));
...
module.exports.clearRequestInterval = clearRequestInterval;
